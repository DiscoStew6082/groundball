...
- This map now authorizes the in-repo Gradio-to-Svelte migration and a bounded private Vercel preview required to prove the stateless application shape. It does not authorize a public or production deployment, paid-plan activation, production-domain changes, secret changes, tunnel deletion, or other production mutations.
...
- A public production deployment, website cutover, or production-domain change before the private stateless Vercel proof passes.
