...
- `stat_definition_ops`: what is OPS - Supported stat definitions use local Markdown corpus provenance before the open LLM path.
- `stat_definition_whip`: what does WHIP mean - Supported stat definitions use local Markdown corpus provenance before the open LLM path.
- `stat_definition_era`: explain ERA - Supported stat definitions use local Markdown corpus provenance before the open LLM path.
- `stat_definition_rbi`: what is an RBI - Supported stat definitions use local Markdown corpus provenance before the open LLM path.
- `stat_definition_stolen_base`: what is a stolen base - Supported stat definitions use local Markdown corpus provenance before the open LLM path.
