...
- `stat_definition_ops`: what is OPS - Supported stat definitions use local Markdown corpus provenance before open LLM fallback.
- `stat_definition_whip`: what does WHIP mean - Supported stat definitions use local Markdown corpus provenance before open LLM fallback.
- `stat_definition_era`: explain ERA - Supported stat definitions use local Markdown corpus provenance before open LLM fallback.
