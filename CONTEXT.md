...
- 2026-07-20, corrected Wave 7 repository tooling: strict request OIDC, Blob API-v12 wire pin, protected/static environment separation, immutable manifests, guarded probes, and Hobby-truth gate derivation. No fixture is live proof; the provider peak-memory and Deployment Attestation gates remain explicitly blocked on Hobby.
